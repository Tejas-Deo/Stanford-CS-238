...
spawn_point = carla.Transform(Location(x=87.5, y=306.886, z=5), Rotation(yaw=0))
...
'''
Add waypoints or specific locations where you want to brake the car.
'''
...
while flag == True:
    ...
    # generate random number using a uniform distribution and check whether the vehicle is braking or accelerating
